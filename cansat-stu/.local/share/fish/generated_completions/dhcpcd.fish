...
complete -c dhcpcd -s c --description 'Use this script instead of the default /lib/dhcpcd/dhcpcd-run-hooks.'
...
complete -c dhcpcd -s o --description 'Request the DHCP option variable for use in /lib/dhcpcd/dhcpcd-run-hooks.'
...
complete -c dhcpcd -s T --description 'On receipt of DHCP messages just call /lib/dhcpcd/dhcpcd-run-hooks with the r…'
